...
- `ROLLBAR_TOKEN` — токен от сервиса Rollbar для логирования.
- `ROLLBAR_ENVIROMENT` — определяет название окружения для логирования в Rollbar.
- `DB_URL` — данные от Базы данных в формате ссылки (используя библиотеку dj-database-url).
